<?php
  function addmovie($movieTitle, $cover, $movieYear, $movieRuntime, $movieStoryline, $movieTrailer,$movieRelease, $genre){
    ...
    $addString = "INSERT INTO tbl_movies VALUES(NULL, '{$cover['name']}', '{$movieTitle}','{$movieYear}', '{$movieRuntime}', '{$movieStoryline}', '{$movieTrailer}', '{$movieRelease}')";//insert the value 1 to the database.
		//echo $userString;
